...
To use module aliases, you must change all the parts labelled with `@mysrtafes2022-layouts`, either substitute in your own bundle name, or something else you feel is appropriate. The main places these are in are:
